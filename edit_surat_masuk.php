...
if(isset($_POST['submit'])) {
  define('MyConst', TRUE);
  include 'function_surat_masuk.php';
  $surat_masuk = new surat_masuk();
  $surat_masuk -> edit_surat_masuk($_POST);
}

$id =$_GET['id'];
$query ="SELECT * FROM tblsurat_masuk WHERE id=$id";
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                  <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                      <h3 class="text-lg font-medium leading-6 text-gray-900 px-10 px-5">Edit Surat Masuk</h3>
                    </div>
                  </div>
                  <div class="mt-5 md:mt-0 md:col-span-2 py-5 px-10">
                    ...
                    <input type="" class="form-control" id="id" name="id" value=<?php echo $id ?> hidden>
                            <div class="text-gray-700">
                                ...
                                <input name="no_surat" value="<?= $data['sm'] ?>" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="" id="forms-labelOverInputCode"/>
                              </div>
                              ...
                              <div class="text-gray-700">
                                <label class="block mb-1" for="forms-labelOverInputCode">Tanggal Diterima</label>
                                <input name="tanggal_diterima" value="<?= $data['tglterima'] ?>" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="date" placeholder="Regular input" id="forms-labelOverInputCode"/>
                              </div>

                              <div class="text-gray-700">
                                <label class="block mb-1" for="forms-labelOverInputCode">Pengirim</label>
                                <input name="pengirim" value="<?= $data['pengirim'] ?>" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="" id="forms-labelOverInputCode"/>
                              </div>
              
                            <div class="col-span-6 sm:col-span-3">
                              <label label class="block mb-1" for="forms-labelOverInputCode">Penerima</label>
                              <input name="penerima" value="<?= $data['penerima'] ?>" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="" id="forms-labelOverInputCode"/>
                            </div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-indigo bg-white-600 hover:bg-indigo-700 ">
                              <a href="surat_masuk.html">Cancel</a>
                              </button>
