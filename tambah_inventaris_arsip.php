...
if(isset($_POST['submit'])) {
  ...
  $inventaris_arsip->add_inventaris_arsip($_POST);
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                  <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                      <h3 class="text-lg font-medium leading-6 text-gray-900 px-10 px-5">Tambah Inventaris Arsip</h3>
                    </div>
                  </div>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                            <div class="text-gray-700">
                              ...
                              <div class="text-gray-700">
                                ...
                                <input name="tanggal_ritensi" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="date" placeholder="Regular input" id="forms-labelOverInputCode"/>
                              </div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-indigo bg-white-600 hover:bg-indigo-700 ">
                               <a href="inventaris_arsip.php">Cancel</a>
                              </button>
