                    ...
                    <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                        <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                            <div class="px-6 py-2 border-b border-light-grey ">
                                <div class="font-bold text-xl">Inventaris Arsip</div>
                            </div>
                            <div>
                                <div class="flex items-stretch justify-start  py-5">
                                    ...
                                    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-5 justify-items-end rounded ">
                                       <a href="tambah_inventaris_arsip.php">Tambah Data</a>
                                       </button>
                                </div>
                            </div>
                            <?php 
                            ...
                            <div class="table-responsive">
                                <table class="table text-grey-darkest">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">Tanggal Retensi</th>
                                    ...
                                    <?php 
	                                $query_mysql = mysqli_query($koneksi, "SELECT * FROM tblinventaris_surat")or die(mysqli_error($koneksi));
	                                $nomor = 1;
	                                foreach ($query_mysql as $data ) {
	                                ?>
                                    <tr>
                                        <th scope="row"><?php echo $nomor++; ?></th>
                                        <td><?php echo $data['isurat']; ?></td>
                                        <td><?php echo $data['tglsurat']; ?></td>
                                        <td><?php echo $data['tglritensi']; ?></td>
                                        <td><?php echo $data['perihal']; ?></td>
                                        <td><a href="public/inventaris_arsip/<?php echo $data['file']; ?>" target="_blank"><?php echo $data['file']; ?></a></td>
                                        <td class="flex items-center">
                                            <a class="edit" href="edit_inventaris_arsip.php?id=<?= $data['id'] ?>">
                                            ...
                                            <form id="hapus-form" action="function_inventaris_arsip.php?hapus" method="POST" class="d-none">
