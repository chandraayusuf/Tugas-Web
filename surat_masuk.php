                    ...
                    <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                        <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                            <div class="px-6 py-2 border-b border-light-grey ">
                                <div class="font-bold text-xl">Surat Masuk</div>
                            </div>
                            <div>
                                <div class="flex items-stretch justify-start  py-5">
                                    ...
                                    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-5 justify-items-end rounded ">
                                       <a href="tambah_surat_masuk.php">Tambah Data</a>
                                       </button>
                                </div>
                            </div>
                            <?php 
                            ...
                            <div class="table-responsive">
                                <table class="table text-grey-darkest">
                                    ...
                                    <?php 
	                                $query_mysql = mysqli_query($koneksi, "SELECT * FROM tblsurat_masuk")or die(mysqli_error($koneksi));
	                                $nomor = 1;
	                                foreach ($query_mysql as $data) {
	                                ?>
                                    <tr>
                                        <th scope="row"><?php echo $nomor++; ?></th>
                                        <td><?php echo $data['sm']; ?></td>
                                        <td><?php echo $data['tglsurat']; ?></td>
                                        <td><?php echo $data['tglterima']; ?></td>
                                        <td><?php echo $data['pengirim']; ?></td>
                                        <td><?php echo $data['penerima']; ?></td>
                                        <td><?php echo $data['perihal']; ?></td>
                                        <td><a href="public/surat_masuk/<?php echo $data['file']; ?>" target="_blank"><?php echo $data['file']; ?></a></td>
                                        <td class="flex items-center">
                                            <a class="edit" href="edit_surat_masuk.php?id=<?php echo $data['id']; ?>">
                                            ...
                                            <form id="hapus-form" action="function_surat_masuk.php?hapus" method="POST" class="d-none">
