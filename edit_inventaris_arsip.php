...
if(isset($_POST['submit'])) {
  define('MyConst', TRUE);
  include 'function_inventaris_arsip.php';
  $inventaris_arsip = new inventaris_arsip();
  $inventaris_arsip -> edit_inventaris_arsip($_POST);
}

$id =$_GET['id'];
$query ="SELECT * FROM tblinventaris_surat WHERE id=$id";
$sql = mysqli_query($koneksi,$query);
if (mysqli_num_rows($sql) == 0) {
    header("location:./inventaris_arsip.php");
  } else {
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                  <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                      <h3 class="text-lg font-medium leading-6 text-gray-900 px-10 px-5">Edit Inventaris Arsip</h3>
                    </div>
                  </div>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <input type="" class="form-control" id="id" name="id" value=<?php echo $id ?> hidden>
                            <div class="text-gray-700">
                                ...
                                <input name="nomor_surat" value="<?= $data['isurat'] ?>" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="" id="forms-labelOverInputCode"/>
                              </div>
                              ...
                              <div class="text-gray-700">
                                <label class="block mb-1" for="forms-labelOverInputCode">Tanggal Retensi</label>
                                <input name="tanggal_ritensi" value="<?= $data['tglritensi'] ?>" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="date" placeholder="Regular input" id="forms-labelOverInputCode"/>
                              </div>
