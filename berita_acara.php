                    ...
                    <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                        <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                            <div class="px-6 py-2 border-b border-light-grey ">
                                <div class="font-bold text-xl">Berita Acara</div>
                            </div>
                            <div>
                                <div class="flex items-stretch justify-start  py-5">
                                    <div class="flex border-2 rounded">
                                        <input type="text" class="px-4 py-2 w-70" placeholder="Search...">
                                     ...
                                     <button class="bg-green-500 hover:bg-green-700 sm= text-white font-bold py-2 px-5 justify-items-end rounded ">
                                        <a href="tambah_berita_acara.php">Tambah Data</a>
                                        </button>
                                </div>
                            </div>
                            <?php 
                            ...
                            <div class="table-responsive">
                                <table border ='1' class="table text-grey-darkest ">
                                    ...
                                    <?php 
	                                include "koneksi.php";
	                                $query_mysql = mysqli_query($koneksi, "SELECT * FROM tblberita_acara");
	                                $nomor = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="public/berita_acara/<?= $data['file'] ?>" target="blank"><?php echo $data['file']; ?></a></td>
                                        <td class="flex items-center">
                                            <a class="edit" href="edit_berita_acara.php?id=<?php echo $data['id']; ?>">
                                            ...
                                            <form id="hapus-form" action="function_berita_acara.php?hapus" method="POST" class="d-none">
