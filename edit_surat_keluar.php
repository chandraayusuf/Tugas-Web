...
if(isset($_POST['submit'])) {
  ...
  $surat_keluar -> edit_surat_keluar($_POST);
}

$id =$_GET['id'];
$query ="SELECT * FROM tblsurat_keluar WHERE id=$id";
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                  <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                      <h3 class="text-lg font-medium leading-6 text-gray-900 px-10 px-5">Edit Surat Keluar</h3>
                    </div>
                  </div>
                  <div class="mt-5 md:mt-0 md:col-span-2 py-5 px-10">
                    ...
                    <input type="" class="form-control" id="id" name="id" value=<?php echo $id ?> hidden>
                            <div class="text-gray-700">
                                ...
                                <input name="nomor_surat" value="<?= $data['skl'] ?>" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="" id="forms-labelOverInputCode"/>
                              </div>
                              ...
                              <div class="text-gray-700">
                                ...
                                <input name="tanggal_dikeluarkan" value="<?= $data['tglkeluar'] ?>" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="date" placeholder="Regular input" id="forms-labelOverInputCode"/>
                              </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                              ...
                              <input name="tujuan" value="<?= $data['tujuan'] ?>" class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" placeholder="" id="forms-labelOverInputCode"/>
                            </div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-indigo bg-white-600 hover:bg-indigo-700 ">
                              <a href="surat_keluar.html">Cancel</a>
                              </button>
