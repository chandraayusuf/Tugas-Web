                    ...
                    <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                        <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                            <div class="px-6 py-2 border-b border-light-grey ">
                                <div class="font-bold text-xl">Surat Keluar</div>
                            </div>
                            <div>
                                <div class="flex items-stretch justify-start  py-5">
                                    ...
                                    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-5 justify-items-end rounded ">
                                        <a href="tambah_surat_keluar.php"> Tambah Data</a>
                                       </button>
                                </div>
                            </div>
                            <?php 
                            ...
                            <div class="table-responsive">
                                <table class="table text-grey-darkest">
                                    ...
                                    <?php 
	                                $query_mysql = mysqli_query($koneksi, "SELECT * FROM tblsurat_keluar")or die(mysqli_error($koneksi));
	                                $nomor = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="public/surat_keluar/<?php echo $data['file']; ?>" target="_blank"><?php echo $data['file']; ?></a></td>
                                        <td class="flex items-center">
                                            <a class="edit" href="edit_surat_keluar.php?id=<?php echo $data['id']; ?>">
                                            ...
                                            <form id="hapus-form" action="function_surat_keluar.php?hapus" method="POST" class="d-none">
